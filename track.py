...
class Opt:
    def __init__(self):
        ...
        self.yolo_weights = 'deep_sort_pytorch/deep_sort/deep/checkpoint/ckpt.t7'
        self.deep_sort_weights = 'yolov5/weights/basketball_robot.pt'
        self.imgsz = 640
        self.evaluate = False
        self.device = '0'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='yolov5/weights/basketball_robot.pt', help='model.pt path')
